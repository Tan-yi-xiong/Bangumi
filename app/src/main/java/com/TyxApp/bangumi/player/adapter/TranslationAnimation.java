 ...
 *
 */
public class TranslationAnimation extends SimpleItemAnimator {
    ...
    public boolean animateAdd(final RecyclerView.ViewHolder holder) {
        ...
        holder.itemView.setTranslationY(startTranslationY);
    ...
    public boolean animateChange(RecyclerView.ViewHolder oldHolder, RecyclerView.ViewHolder newHolder,
        ...
        if (newHolder != null) {
            ...
            newHolder.itemView.setTranslationY(startTranslationY == 0 ? -deltaY : startTranslationY);
